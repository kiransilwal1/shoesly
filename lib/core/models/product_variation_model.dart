...
class ProductVariationModel extends ProductVariation {
  ...
  @override
  String toString() {
    return 'ProductVariationModel(id: $id, colorcode: $colorCode, colorname: $colorName, image: $image, size: $size, created_at: $createdAt, product_id: $productId,price: $price,brandimage: $brandimage,title: $title,brandname:$brandimage)';
  }
