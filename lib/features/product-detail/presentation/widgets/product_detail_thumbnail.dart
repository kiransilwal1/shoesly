...
class ProductDetailThumbnail extends StatefulWidget {
  ...
  final ShoeDetailsEntity shoes;
  final String mainImageUrl;
  final Size size;
  final Null Function(ShoeVariations shoe) onSwiped;
          ...
          children: [
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: widget.shoes.shoeVariations.length,
                itemBuilder: (context, index) {
                  return CachedNetworkImage(
                      imageUrl: widget.shoes.shoeVariations[index].imageUrl);
                },
              ),
            ),
            const SizedBox(
